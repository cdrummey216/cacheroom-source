...
class About extends Component {
  ...
  render() {
    return (
      ...
      <section id='donate'>
          <h4>Donate</h4>
          <p>CacheRoom is maintained and hosted by one developer with a full-time job. If you get some value
          from this service I would appreciate any donation you can afford. I use these funds for
          server and DNS costs. Thank you!
          </p>
          <strong>Bitcoin</strong>
          <p>3MSVAibY7ASjCUTyNAvmTHSyZb8fZZAYmf</p>
          <strong>Ethereum</strong>
          <p>0x60AE886e7a3a4baa1414f15151Cd9C96893F1bD1</p>
          <strong>Litecoin</strong>
          <p>M93XzkWhDZzjkZBDzaWGhRRuRa22JwNCpX</p>
        </section>
        ...
        <section id='software'>
          ...
          <p>I believe in privacy and transparency.</p>
        </section>
        ...
        <section id='acceptable-use'>
          ...
          <p>This Acceptable Use Policy (this “Policy”) describes prohibited uses of the web services offered by CacheRoom and its affiliates (the “Services”). The examples described in this Policy are not exhaustive. We may modify this Policy at any time by posting a revised version on the CacheRoom Site. By using the Services or accessing the CacheRoom Site, you agree to the latest version of this Policy. If you violate the Policy or authorize or help others to do so, we may suspend or terminate your use of the Services.</p>
          
          <strong>No Illegal, Harmful, or Offensive Use or Content</strong>
          <p>You may not use, or encourage, promote, facilitate or instruct others to use, the Services or CacheRoom Site for any illegal, harmful, fraudulent, infringing or offensive use, or to transmit, store, display, distribute or otherwise make available content that is illegal, harmful, fraudulent, infringing or offensive. Prohibited activities or content include:</p>
          ...
          <br/>We reserve the right, but do not assume the obligation, to investigate any violation of this Policy or misuse of the Services or CacheRoom Site. I may:
          <ul>
            <li>investigate violations of this Policy or misuse of the Services or CacheRoom Site; or</li>
            <li>remove, disable access to, or modify any content or resource that violates this Policy or any other agreement we have with you for use of the Services or the CacheRoom Site.</li>
        ...
        <section id='terms'>
          ...
          <p>Please read these Terms of Service ("Terms", "Terms of Service") carefully before using the website (the "Service") operated by CacheRoom ("us", "we", or "our").</p>
          <p>Your access to and use of the Service is conditioned on your acceptance of and compliance with these Terms. These Terms apply to all visitors, users and others who access or use the Service.</p>
          <p>By accessing or using the Service you agree to be bound by these Terms. If you disagree with any part of the terms then you may not access the Service.</p>
          <strong>Links To Other Web Sites</strong>
          <p>Our Service may contain links to third-party web sites or services that are not owned or controlled by CacheRoom.</p>
          <p>CacheRoom has no control over, and assumes no responsibility for, the content, privacy policies, or practices of any third party web sites or services. You further acknowledge and agree that CacheRoom shall not be responsible or liable, directly or indirectly, for any damage or loss caused or alleged to be caused by or in connection with use of or reliance on any such content, goods or services available on or through any such web sites or services.</p>
  ...
  regarding our Service, and supersede and replace any prior agreements we might have between us regarding the Service.</p>
        ...
        <section id='disclaimer'>
          <h4>Disclaimer</h4>
          <p className="bold">WARNING: CacheRoom does not mask IP addresses nor can verify the integrity of parties recieving messages.
          ...
          &nbsp;Anyone can guess your room URL. If you need a more-private room, use the lock feature or set the URL manually by entering a room ID after &quot;https://cmd317-encrypted-web-app.herokuapp.com/&quot;.
          </p>
          <br />
          <strong>No Warranties; Exclusion of Liability; Indemnification</strong>
          <p><strong>OUR WEBSITE IS OPERATED BY CacheRoom ON AN "AS IS," "AS AVAILABLE" BASIS, WITHOUT REPRESENTATIONS OR WARRANTIES OF ANY KIND. TO THE FULLEST EXTENT PERMITTED BY LAW, CacheRoom SPECIFICALLY DISCLAIMS ALL WARRANTIES AND CONDITIONS OF ANY KIND, INCLUDING ALL IMPLIED WARRANTIES AND CONDITIONS OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, TITLE AND NONINFRINGEMENT FOR OUR WEBSITE AND ANY CONTRACTS AND SERVICES YOU PURCHASE THROUGH IT. CacheRoom SHALL NOT HAVE ANY LIABILITY OR RESPONSIBILITY FOR ANY ERRORS OR OMISSIONS IN THE CONTENT OF OUR WEBSITE, FOR CONTRACTS OR SERVICES SOLD THROUGH OUR WEBSITE, FOR YOUR ACTION OR INACTION IN CONNECTION WITH OUR WEBSITE OR FOR ANY DAMAGE TO YOUR COMPUTER OR DATA OR ANY OTHER DAMAGE YOU MAY INCUR IN CONNECTION WITH OUR WEBSITE. YOUR USE OF OUR WEBSITE AND ANY CONTRACTS OR SERVICES ARE AT YOUR OWN RISK. IN NO EVENT SHALL EITHER CacheRoom OR THEIR AGENTS BE LIABLE FOR ANY DIRECT, INDIRECT, PUNITIVE, INCIDENTAL, SPECIAL OR CONSEQUENTIAL DAMAGES ARISING OUT OF OR IN ANY WAY CONNECTED WITH THE USE OF OUR WEBSITE, CONTRACTS AND SERVICES PURCHASED THROUGH OUR WEBSITE, THE DELAY OR INABILITY TO USE OUR WEBSITE OR OTHERWISE ARISING IN CONNECTION WITH OUR WEBSITE, CONTRACTS OR RELATED SERVICES, WHETHER BASED ON CONTRACT,
  TORT, STRICT LIABILITY OR OTHERWISE, EVEN IF ADVISED OF THE POSSIBILITY OF ANY SUCH DAMAGES. IN NO EVENT SHALL CacheRoom’s LIABILITY FOR ANY DAMAGE CLAIM EXCEED THE AMOUNT PAID BY YOU TO CacheRoom FOR THE TRANSACTION GIVING RISE TO SUCH DAMAGE CLAIM.</strong></p>
          ...
          <p><strong>WITHOUT LIMITING THE FOREGOING, CacheRoom DO NOT REPRESENT OR WARRANT THAT THE INFORMATION ON THE WEBITE IS ACCURATE, COMPLETE, RELIABLE, USEFUL, TIMELY OR CURRENT OR THAT OUR WEBSITE WILL OPERATE WITHOUT INTERRUPTION OR ERROR.</strong></p>
          <p><strong>YOU AGREE THAT ALL TIMES, YOU WILL LOOK TO ATTORNEYS FROM WHOM YOU PURCHASE SERVICES FOR ANY CLAIMS OF ANY NATURE, INCLUDING LOSS, DAMAGE, OR WARRANTY. CacheRoom AND THEIR RESPECTIVE AFFILIATES MAKE NO REPRESENTATION OR GUARANTEES ABOUT ANY CONTRACTS AND SERVICES OFFERED THROUGH OUR WEBSITE.</strong></p>
          <p><strong>CacheRoom MAKES NO REPRESENTATION THAT CONTENT PROVIDED ON OUR WEBSITE, CONTRACTS, OR RELATED SERVICES ARE APPLICABLE OR APPROPRIATE FOR USE IN ALL
  JURISDICTIONS.</strong></p>
          <strong>Indemnification</strong>
          <p>You agree to defend, indemnify and hold CacheRoom harmless from and against any and all claims, damages, costs and expenses, including attorneys' fees, arising
